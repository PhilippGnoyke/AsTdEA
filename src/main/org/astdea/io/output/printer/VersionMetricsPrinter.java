...
class VersionMetricsPrinter implements PrinterCore
{
    private static final String[] headers1 = ResultHeaders.getVersionHeadersPt1();
    private static final String[] headers2 = ResultHeaders.getVersionHeadersPt2();
    private static final String[] headers3 = ResultHeaders.getVersionHeadersPt3();
    ...
    private int initOldVals(String[] headers, int valsInd) throws IOException
    {
        Map<String, String> presentVals = CsvReadingUtils.readCsvColumnsOf1RowFile
            (file, ResultHeaders.getVersionHeadersPt2());
        for (String header : headers)
        {
